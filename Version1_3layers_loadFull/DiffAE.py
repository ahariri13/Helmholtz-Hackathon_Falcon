...
class GraphAE(torch.nn.Module):
    ...
    def encode(self,x,adj,lengs,refMat):  
        ...
        r1,r2,adjMat,_,_= self.enc(whole[0].cuda(),wholeAdj.cuda(),refMat)
    ...
    def forward(self,x,adj,lengs,refMat):
        mu,logvar,adjMat = self.encode(x,adj,lengs,refMat)     ## mu, log sigma 
